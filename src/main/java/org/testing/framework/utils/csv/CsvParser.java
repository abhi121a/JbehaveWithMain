...
public class CsvParser {
    ...
    /**
     * This will take a csv file location and create a data table model from it
     *
    ...
    /**
     * This will take a csv file and create a data table model from it
     *
    ...
    public ArrayList<ArrayList<String>> createArrayListFromCSVFile(File file) {
        ...
        try {
            ...
            // Create a array list of strings that will hold the data
    ...
    /**
     * This will take a csv file as a string and create a data list model from it
     *
