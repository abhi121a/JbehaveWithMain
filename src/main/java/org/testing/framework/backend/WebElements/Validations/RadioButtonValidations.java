 ...
 */
public class RadioButtonValidations extends PageObject {

    static Logger logger = LoggerFactory.getLogger(RadioButtonValidations.class.getName());

    public RadioButtonValidations(WebDriver driver) {
        super(driver);
    }


    /**
     * This will assert whether a radioButton is checked or not
     *
     ...
     * @throws Exception If the radioButton was meant to be clicked but is not then it will throw error. And vice-versa.
     */
    public void isRadioButtonChecked(final boolean checked, final String field, final String beanFileName, final String beanPath) throws Exception {
