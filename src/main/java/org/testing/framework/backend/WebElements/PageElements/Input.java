...
public class Input extends PageObject {
     ...
     * @throws Exception        If the value can not be input
     */
    public void input_the_element(final String value, final String field, String fieldReplacementValue1,String fieldReplacementValue2, final String beanFileName, final String beanPath) throws Exception {
        WebElementLocator elementLocator = WebElementLocator.getInstance();
        logger.info(LoadProjectProperties.getStringProperty(LoadProjectProperties.REPLACE_CHARACTER));
        WebElement elementFound = elementLocator.locateElement(field, fieldReplacementValue1,
                LoadProjectProperties.getStringProperty(LoadProjectProperties.REPLACE_CHARACTER),fieldReplacementValue2,
                LoadProjectProperties.getStringProperty(LoadProjectProperties.REPLACE_CHARACTER_2), beanFileName, beanPath,
                getDriver(), true);
        elementFound.clear();
